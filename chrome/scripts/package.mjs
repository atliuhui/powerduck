// Zip chrome/dist into a versioned archive (DEFLATE compressed) next to package.json.
...
const zipPath = join(root, `power-duck-chrome-${pkg.version}.zip`);
...
out.end(() => {
  ...
  console.log(`[chrome:package] ${zipPath} (${(finalSize/1024/1024).toFixed(2)} MB)`);
});
